...
async def get_owner_stats(
    ...
    # Active enrollments across all batches of this institute
    ...
    # Fees collected (amount_paid sum) for this calendar month
    ...
    # Average attendance % across all sessions this month
    # Sessions this month for this institute
