...
This project is indexed by GitNexus as **BatchBook** (212 symbols, 248 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
