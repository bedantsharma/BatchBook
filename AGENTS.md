...
This project is indexed by GitNexus as **BatchBook** (1347 symbols, 1850 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
