...
This project is indexed by GitNexus as **BatchBook** (454 symbols, 571 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
