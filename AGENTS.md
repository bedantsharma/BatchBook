...
This project is indexed by GitNexus as **BatchBook** (253 symbols, 302 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
