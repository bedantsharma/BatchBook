from .student_base import StudentSchema
from .owner_base import OwnerSchema
from .institute_base import InstituteSchema
from .teacher_base import TeacherSchema
...
from .test_score_base import ScoreSchema
