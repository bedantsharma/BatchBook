...
This project is indexed by GitNexus as **BatchBook** (3647 symbols, 5878 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
