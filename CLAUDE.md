...
This project is indexed by GitNexus as **BatchBook** (4162 symbols, 6754 relationships, 86 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
