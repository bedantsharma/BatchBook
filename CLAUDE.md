...
This project is indexed by GitNexus as **BatchBook** (897 symbols, 1114 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
