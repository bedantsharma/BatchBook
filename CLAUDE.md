...
This project is indexed by GitNexus as **BatchBook** (4289 symbols, 7022 relationships, 87 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
